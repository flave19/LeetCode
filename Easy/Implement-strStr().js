var strStr = function (haystack, needle) {
  ...
  if (haystack.length < needle.length) return -1; // the other edge cases are for efficiency

  for (let i = 0; i < haystack.length; i++) {   // start looping through haystack until the remaining substring is shorter than needle
